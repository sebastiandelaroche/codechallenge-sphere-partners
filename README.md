...
- I created a hook to get the data from the server side and tweak the App.js replacing the hardcode data for the server data
- I used useState hook in order to have the components's control (dropdown and datepicker)
- I created a couple of utilities to transform the data structure for the desire one
- I used useMemo hook for the transformed data.
...
- I used Antd, just for simplicity and wrapping up fast since it's a library that I've been using lately.
- I created a new Component Reservation for each reservation and then I reused it in the ReservationList component
- I created the Reservation.css file to put custom styles
. I created extra utils for format date and validations in utils.js
...
- I developed the requested functionality and process with the basic test.
